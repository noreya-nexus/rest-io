...
impl AnalogThresholdJson {
    ...
    pub fn new(pin : u8, threshold_ms: u16, direction: String) -> AnalogThresholdJson {
        AnalogThresholdJson{ pin, threshold_millivolt: threshold_ms, trigger: direction }
    }

    pub fn create_default() -> AnalogThresholdJson {
        AnalogThresholdJson {pin : 0, threshold_millivolt: 0, trigger: "low".to_string()}
    }
}
